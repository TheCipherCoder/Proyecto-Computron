...
import vistas.Productos.Consulta;
import vistas.Productos.Eliminar;
import vistas.Productos.Ingreso;
import vistas.Productos.Listar;
import vistas.Productos.Modificar;
...
public class MantenimientoProducto extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MantenimientoProducto frame = new MantenimientoProducto();
	...
	public MantenimientoProducto() {
		...
		ImageIcon ingresoImg = new ImageIcon("C:\\Users\\usuario\\Desktop\\TEAMPAPOS_PROYECTO_JAVA\\AppJava\\src\\iconos\\pc.png");
		Image ingresoImg1 = ingresoImg.getImage();
		Image ingresoImg2 = ingresoImg1.getScaledInstance(115, 115,Image.SCALE_SMOOTH);
		ImageIcon ingresoImg2Red = new ImageIcon(ingresoImg2);
		
		btnIngreso = new JButton("");
		btnIngreso.addActionListener(this);
		btnIngreso.setIcon(ingresoImg2Red);
