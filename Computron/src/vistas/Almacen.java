...
public class Almacen extends JFrame implements ActionListener {
	...
	private JScrollPane scrollPreVisualizacion;
	...
	public Almacen() {
		...
		lblPrevisualizacionDeLa = new JLabel(
				"PREVISUALIZACION DE LA MODIFICACIÓN DE STOCK DE LOS PRODUCTOS SELECCIONADOS");
		...
		scrollPreVisualizacion = new JScrollPane();
		scrollPreVisualizacion.setViewportBorder(null);
		scrollPreVisualizacion.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		scrollPreVisualizacion.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		scrollPreVisualizacion.setBounds(10, 194, 610, 41);
		contentPane.add(scrollPreVisualizacion);
		...
		scrollPreVisualizacion.setViewportView(tblPreVisualizacion);

		// FIN DE LA TABLA DE LA PREVISUALIZACION

		// INICIO DE LA TABLA DONDE SE MOSTRARAN LOS PRODUCTOS A LOS CUALES SE LES
		...
		encabezadoTablaProducto = new String[] { "C\u00F3digo", "Nombre", "Stock Anterior", "Cantidad Ingresada",
				"Stock Final", "Stock m\u00E1ximo" };
		// CREACION DEL SCROLL BAR
		scrollProductos = new JScrollPane();
		scrollProductos.setBounds(10, 269, 774, 291);
	...
	protected void actionPerformedBtnGuardar(ActionEvent e) {
		...
		reiniciarTablaPro();
		contadorFilas = 1;
		JOptionPane.showMessageDialog(null, "El stock de los productos seleccionados se ha actualizado correctamente",
